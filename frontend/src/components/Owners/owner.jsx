...
const OwnerPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (activeTab === "register" && validateRegistration()) {
      ...
      try {
        const response = await fetch("https://machineryrentalhub-backend-production.up.railway.app/owner/register", {
          method: "POST",
      ...
      try {
        const response = await fetch("https://machineryrentalhub-backend-production.up.railway.app/owner/login", {
          method: "POST",
          headers: {

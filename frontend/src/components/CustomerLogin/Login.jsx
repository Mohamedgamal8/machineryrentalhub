...
const Login = () => {
  ...
  const handleLoginSubmit = async (e) => {
    ...
    if (LoginInfo.email && LoginInfo.password) {
      ...
      try {
        const url = "https://machineryrentalhub-backend-production.up.railway.app/auth/login";
        // const url = "https://machineryrentalhub-backend-production.up.railway.app/login";

          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="faq-item bg-white p-8 rounded-lg shadow-lg hover:shadow-2xl flex flex-col lg:flex-row transition-all">
              <div>
                ...
                <p className="faq-answer text-gray-700 mt-4">
                  There are no hidden fees. However, optional add-ons such as insurance, or additional drivers may incur extra charges. All costs will be clearly displayed before confirming your booking.
                </p>
              </div>
            </div>
